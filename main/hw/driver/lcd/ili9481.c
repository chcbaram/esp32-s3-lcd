...
void cliCmd(cli_args_t *args)
{
  ...
  if (args->argc == 1 && args->isStr(0, "info"))
  {
    ...
    buf[1] = 0x42;
    buf[2] = 0x18;
    dbiWriteParam(&lcd_bus, ILI9481_WR_POWER_SET, buf, 3);

    buf[0] = 0x00;
    buf[1] = 0x07;
    buf[2] = 0x10;
    dbiWriteParam(&lcd_bus, ILI9481_WR_VCOM_CONTROL, buf, 3);

    buf[0] = 0x01;
    buf[1] = 0x02;
    dbiWriteParam(&lcd_bus, 0xD2, buf, 2);
    ...
    buf[3] = 0x02;
    buf[4] = 0x11;
    dbiWriteParam(&lcd_bus, 0xC0, buf, 5);

    buf[0] = 0x03;
    dbiWriteParam(&lcd_bus, 0xC5, buf, 1);
    ...
    buf[10] = 0x0C;
    buf[11] = 0x00;
    dbiWriteParam(&lcd_bus, 0xC8, buf, 12);

    buf[0] = 0x55;
    dbiWriteParam(&lcd_bus, 0x3A, buf, 1);
